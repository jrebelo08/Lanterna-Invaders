...
public class DrawTutorialTest {
    ...
    public void testDraw() {
        ...
        verify(gui).drawText(new PositionModel(33, 24-2), "$", new TextColor.RGB(0, 0 ,255));
        verify(gui).drawText(new PositionModel(38, 24-2), "SHOOT THE POWERUPS TO GAIN POWERS", new TextColor.RGB(255, 255 ,255));
        verify(gui).drawText(new PositionModel(29, 24), "♥", new TextColor.RGB(255, 0 ,0));
        verify(gui).drawText(new PositionModel(38, 24), "YOU HAVE ONLY 3 LIVES", new TextColor.RGB(255, 255 ,255));

        verify(gui).drawText(new PositionModel(35, 27), "POWERUPS", new TextColor.RGB(178, 73 ,210));

        verify(gui).drawText(new PositionModel(29, 30), "+", new TextColor.RGB(0, 255 ,0));
        verify(gui).drawText(new PositionModel(38, 30), "EXTRA LIFE", new TextColor.RGB(255, 255 ,255));
        verify(gui).drawText(new PositionModel(29, 32), "★", new TextColor.RGB(255, 255 ,0));
        verify(gui).drawText(new PositionModel(38, 32), "5X SCORE BOOST", new TextColor.RGB(255, 255 ,255));
        verify(gui).drawText(new PositionModel(29, 34), "$", new TextColor.RGB(0, 0 ,255));
        verify(gui).drawText(new PositionModel(38, 34), "FIRE RATE BOOST", new TextColor.RGB(255, 255 ,255));
